...
<body background="img/bg1.jpg" style=" background-repeat:no-repeat ;
...
<div class="col-xs-6 col-md-offset-3" style="position: relative; padding: 30px 170px 10px;">
        ...
        <div class="panel-body">
            <form method="post" action="admin_repasswd_do" id="repasswd">
                ...
                <div class="input-group" style="padding-top: 15px;">
                    ...
                    <br/>
                    <span>
                            <input type="submit" value="提交" class="btn btn-default" style="padding-top: 10px;margin-left: 30%">
                    </span>
