...
<div class="panel panel-default" style="width: 85%;top: 80px;margin-left: 13%">
            ...
            <c:forEach items="${books}" var="book">
                <tr>
                    ...
                    <c:if test="${not flag}">
                        <c:if test="${book.number>0}">
                            <td><a href="lendbook.html?bookId=<c:out value="${book.bookId}"></c:out>">
                                <button type="button" class="btn btn-success">借阅</button>
                            </a></td>
                        </c:if>
                        <c:if test="${book.number==0}">
                            <td>
                    ...
                    <td><a href="reader_book_detail.html?bookId=<c:out value="${book.bookId}"></c:out>">
                        <button type="button" class="btn">详情</button>
                    </a></td>
                </tr>
            </c:forEach>
            </tbody>
