        ...
        <div class="panel-body">
            <form action="reader_edit_do.html?readerId=${readerInfo.readerId}" method="post" id="readeredit" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="birth" id="birth"  value="${readerInfo.birth}" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}"
                ...
                <input type="submit" value="确定" class="btn btn-success" class="text-left">
                <script>
