...
<div class="col-xs-7 col-md-offset-2" style="padding-top: 30px;position: relative">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="book_add_do.html" method="post" id="addbook">
                ...
                <input type="submit" value="添加" class="btn btn-success" class="text-left" style="margin-left: 45%">
                <script>
